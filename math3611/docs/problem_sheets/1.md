...
!!! success "Proof Sketch"
    ...
    5. The possible digits for each decimal are $\{0, 1, 2, 3, 4, 5, 6, 8, 9\}$. There are at most $\mathbb{N}$ decimal points. We can write the possible decimal expansions as a list where each entry in the double is a decimal place: $\{(0, 0, \dots), (1, 0, \dots), \dots, (0, 1, 0, \dots), (0, 2, 0, \dots), \dots \},$ which by definition is countable. Note that this is also equivalent to $9^\mathbb{N}$.
