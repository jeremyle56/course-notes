...
\exmp{
    \(10 \bZ \trianglelefteq \bZ\) is not maximal as \(10\bZ \subsetneqq 2\bZ \triangle \bZ\). However \(2\bZ \trianglelefteq \bZ\) is maximal.
}
...
\exmp{
    \(S = \bC[x]\) subring of \(R = \bC[x, y].\) Let \(I = \langle y \rangle = y\bC[x, y]\). \\
